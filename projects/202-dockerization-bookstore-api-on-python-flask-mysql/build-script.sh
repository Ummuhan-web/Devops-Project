...
TOKEN="xxxxxxxxx"
FOLDER="https://$TOKEN@raw.githubusercontent.com/Ummuhan-web/clarusway-devops-workshop/tree/master/projects/202-dockerization-bookstore-api-on-python-flask-mysql/"
